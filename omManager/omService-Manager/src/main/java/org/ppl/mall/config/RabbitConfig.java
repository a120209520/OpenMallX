...
public class RabbitConfig {
    ...
    @Bean
    public Queue solrItemAddQueue(RabbitAdmin rabbitAdmin) {
        Queue queue = new Queue(env.getProperty("rabbit.itemAdd.solr.queue"));
    ...
    public Binding itemAddBinding(RabbitAdmin rabbitAdmin,
                                  ...
                                  Queue solrItemAddQueue) {
        Binding binding = BindingBuilder.bind(solrItemAddQueue).
                to(itemAddExchange).
                with(env.getProperty("rabbit.itemAdd.solr.routingKey"));
